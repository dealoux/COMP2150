...
public interface A4POSServer {
   ...
   /**
    * Show all the transactions of a client.
    *
    * @param  client the client ID
    * @return a string describing all the transaction(s) of a client or null on error
    *         (ID, type, time, all the items, and whether or not it is complete)
    */
   String toString(int client);
