 ...
 *
 * New for assignment 3: a set of calls used to search for items by description:
 *  search() - begin a search through item codes and descriptions
 *  next() - get the next match for the search
 *  queryMatch() - get information about the current match
 */

public interface A3POSServer {
   enum TransactionType {
      PURCHASE, RETURN, BACKORDER
   }
